  ...
  return (
    <div className="w-64 sm:w-72 lg:w-64 bg-[#1A2440] text-white flex flex-col h-full">
      ...
      <div className="p-3 sm:p-4 border-t border-white/10">
        <button
          onClick={onLogout}
          className="w-full flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 sm:py-3 text-gray-300 hover:bg-red-500/10 hover:text-red-400 rounded-lg transition-colors"
        >
          <LogOut className="w-4 h-4 sm:w-5 sm:h-5 shrink-0" />
          <span className="text-xs sm:text-sm truncate">Cerrar Sesión</span>
        </button>
      </div>
    </div>
  );
