  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[#1A2440]">Gestión de Clientes</h1>
          <p className="text-gray-600 mt-1">Administra la base de clientes</p>
        </div>
      ...
      {canDelete && (
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 flex items-center gap-3">
          ...
          <p className="text-sm text-purple-700">
            <span className="font-semibold">Modo Super Admin:</span> Puedes eliminar clientes permanentemente
          </p>
        </div>
      )}
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-8">
        <div className="text-center">
          ...
          <h3 className="font-semibold text-lg text-[#1A2440] mb-2">Módulo de Clientes</h3>
