  ...
  const notifications = [
    {
      ...
      message: 'Reserva #RES-156 agregada al sistema',
      time: 'Hace 10 min',
      unread: true,
    },
    {
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-500">
              <Shield className="w-3 h-3 sm:w-4 sm:h-4 text-[#3A7AFE]" />
              <span className="hidden sm:inline font-medium text-[#3A7AFE]">Administrador</span>
              <span className="sm:hidden font-medium text-[#3A7AFE]">Admin</span>
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-amber-50 border border-amber-200 rounded-lg">
            ...
            <span className="text-xs text-amber-700">Sin permiso de eliminar</span>
          </div>
          ...
          <div className="relative">
            ...
            >
              <div className="w-10 h-10 bg-gradient-to-br from-[#3A7AFE] to-blue-600 rounded-full flex items-center justify-center ring-2 ring-blue-200">
                <Shield className="w-5 h-5 text-white" />
              </div>
              <div className="text-left hidden md:block">
                <p className="text-sm font-medium text-[#1A2440]">{user.name}</p>
                <p className="text-xs text-[#3A7AFE] font-medium">Admin</p>
              </div>
            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 z-20">
                ...
                />
                <div className="p-4 border-b border-gray-200 relative z-20 bg-gradient-to-br from-blue-50 to-indigo-50">
                  <div className="flex items-center gap-3 mb-2">
                    <Shield className="w-5 h-5 text-[#3A7AFE]" />
                    <span className="text-xs font-semibold text-[#3A7AFE] uppercase tracking-wide">
                      Administrador
                    </span>
                  </div>
